...
export class CompanyQueryDto {
  ...
  @IsOptional()
  @IsDateString({}, { message: 'joinedFrom must be a valid ISO-8601 date string' })
  ...
  @IsOptional()
  @IsDateString({}, { message: 'joinedTo must be a valid ISO-8601 date string' })
  @Transform(({ value }) => value ? new Date(value).toISOString() : undefined)
  joinedTo?: string;
  ...
  @IsOptional()
  @IsDateString({}, { message: 'transferFrom must be a valid ISO-8601 date string' })
  @Transform(({ value }) => value ? new Date(value).toISOString() : undefined)
  transferFrom?: string;
  ...
  @IsOptional()
  @IsDateString({}, { message: 'transferTo must be a valid ISO-8601 date string' })
  @Transform(({ value }) => value ? new Date(value).toISOString() : undefined)
  transferTo?: string;
}